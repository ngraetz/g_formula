...
DF <- readRDS(paste0('./data/', run_name, '.RDS'))
...
if(!file.exists("./bootruns.Rds") | rerun_boots==TRUE) {
  ...
  saveRDS(bootruns, paste0("./boots/", run_name , ".Rds"))
  
}

bootruns <- read_rds(paste0("./boots/", run_name , ".Rds"))
